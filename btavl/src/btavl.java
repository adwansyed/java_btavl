...
public class btavl {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("time(tree setup) AVL= " + treeSetup + " ms");
        System.out.println("time(average applySearch) AVL= " + averageSearch + " ms");
        System.out.println("time(average at) AVL= " + averageAt + " ms");
    }
